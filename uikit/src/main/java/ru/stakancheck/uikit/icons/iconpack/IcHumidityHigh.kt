...
public val IconPack.IcHumidityHigh: ImageVector
    get() {
        if (_icHumidityHigh != null) {
            return _icHumidityHigh!!
        }
        _icHumidityHigh = Builder(
            name = "IcHumidityHigh", defaultWidth = 24.0.dp, defaultHeight =
...
private var _icHumidityHigh: ImageVector? = null
